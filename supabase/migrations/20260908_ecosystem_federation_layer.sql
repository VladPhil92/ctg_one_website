...
-- Registry metadata is safe for authenticated ecosystem users to read.
...
-- Users can inspect only their own explicit links. Mutations are server-side
-- service-role operations after the relevant product trust contract is verified.
