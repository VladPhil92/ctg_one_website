-- Correct the authoritative System Health trigger names introduced in 0017.
-- The underlying 0012 guards were healthy; 0017 used pluralized names for
-- allocation and settlement triggers and therefore undercounted them.
