-- Fase 5A — Financial Security Step-Up Telemetry
--
...
-- Migration-time fail-closed contract: a bad grant or missing immutability control
-- must prevent this migration from being considered applied.
do $$
declare
