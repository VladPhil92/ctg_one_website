...
This phase does **not** reserve a migration number or filename. Parallel development can advance `main`; a migration slot must therefore be allocated only from the exact trusted `main` baseline used by the future reviewed implementation PR.
