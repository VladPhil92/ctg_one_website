...
This manifest records the exact user-supplied visual masters accepted on 2026-09-11 for the public World Makers experience. The latest accepted set supersedes earlier visual-master mappings whenever the same role is listed below.
...
| Gameplay · Exploration / Research Dome | `1000790714.png` | 1536×864 | 497280 | `13168d34a21081bd3d1e9dd7ca200358851e36c45cef414110defd69c944707b` |
...
- `WORLDMK_ASSET_GAMEPLAY_EXPLORATION_URL` — latest Research Dome / first-person exploration master
- `WORLDMK_ASSET_GAMEPLAY_BUILD_URL` — legacy compatibility alias only; do not prefer for the latest set
