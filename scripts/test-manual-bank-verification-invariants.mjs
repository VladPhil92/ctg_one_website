...
assert.ok(paymentConfig.includes('/images/inversion/bancolombia-breb-grupo-pisao.jpg'), 'Investment payment rail must point to the approved first-party QR asset supplied for checkout.');
