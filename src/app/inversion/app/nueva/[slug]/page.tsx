  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white overflow-hidden">
      ...
      <section className="relative z-10 py-14 sm:py-20">
        <Container>
          <Link href="/inversion/app" className="inline-flex items-center gap-2 text-[10px] uppercase tracking-[.18em] text-text-dim hover:text-accent transition-colors mb-6"><ArrowLeft size={13}/> Volver a mis inversiones</Link>
