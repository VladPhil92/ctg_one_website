...
import {
  ...
  KEV_AUTHORIZATION_CODE_TTL_MS,
  KEV_CANONICAL_ORIGIN,
...
export async function GET(request: Request) {
  ...
  const expiresAt = new Date(createdAt.getTime() + KEV_AUTHORIZATION_CODE_TTL_MS);
  ...
  const destination = new URL('/auth/ctgone/callback', KEV_CANONICAL_ORIGIN);
