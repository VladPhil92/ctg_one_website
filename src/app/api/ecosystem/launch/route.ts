...
export async function GET(request: Request) {
  ...
  // Never place a CTG One bearer/session token in the URL. The destination app
  // starts its own authorization-code + PKCE exchange and creates an independent
  // local session after CTG One validates this browser session.
