...
import { WorldMakersCommunityPanel } from '@/components/admin/WorldMakersCommunityPanel';

export const dynamic = 'force-dynamic';

export default async function WorldMakersCommunityAdminPage() {
  ...
  return <WorldMakersCommunityPanel />;
}
