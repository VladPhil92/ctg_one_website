...
import { RewardsSourceConnectorsPanel } from '@/components/admin/RewardsSourceConnectorsPanel';

export const dynamic = 'force-dynamic';

export default async function RewardsSourceConnectorsAdminPage() {
  ...
  return <RewardsSourceConnectorsPanel />;
}
