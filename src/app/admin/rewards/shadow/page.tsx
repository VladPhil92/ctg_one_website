...
import { RewardsShadowEnginePanel } from '@/components/admin/RewardsShadowEnginePanel';

export const dynamic = 'force-dynamic';

export default async function RewardsShadowEngineAdminPage() {
  ...
  return <RewardsShadowEnginePanel />;
}
