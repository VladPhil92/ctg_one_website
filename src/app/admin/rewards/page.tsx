...
import { RewardsPilotControlPlane } from '@/components/admin/RewardsPilotControlPlane';

export const dynamic = 'force-dynamic';

export default async function RewardsPilotAdminPage() {
  ...
  return <RewardsPilotControlPlane />;
}
