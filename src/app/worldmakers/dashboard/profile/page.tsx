import { ctgOneUrl, worldMakersPublicUrl } from '@/lib/worldmakers/routes';
    ...
    <section className={styles.section}>
      ...
      <div className={styles.profileGrid}>
        ...
        <article className={styles.profileCard}>
          ...
          <a href={worldMakersPublicUrl('/privacy')}>Ver privacidad →</a>
        </article>
        <article className={styles.profileCard}>
          <strong>Comunidad</strong>
          <p>Participa en novedades, investigación y futuras oportunidades de prueba cuando estén disponibles.</p>
          <a href={worldMakersPublicUrl('/community')}>Ir a comunidad →</a>
        </article>
      </div>
    </section>
  );
