...
export const ECOSYSTEM_TECHNOLOGY_UNITS: EcosystemTechnologyUnit[] = [
  ...
  },
  {
    ...
    currentStateEs: 'Es el caso de tecnología aplicada más completo del ecosistema mediante CTG Craft Beer Inversión.',
    currentStateEn: 'This is the ecosystem’s most complete applied technology case through CTG Craft Beer Investment.',
    status: 'LIVE',
    capabilities: [
      { nameEs: 'Lotes e inventario', nameEn: 'Batches and inventory', status: 'LIVE' },
      { nameEs: 'Ledger y asignaciones', nameEn: 'Ledger and allocations', status: 'LIVE' },
