...
export const TECHNOLOGY_PROOF: ProofItem[] = [
  ...
  },
  {
    ...
    capability: 'Governed AI architecture, model gateway, RAG design, agent runtime and evaluation model',
  ...
  },
  {
    ...
    area: 'Artificial Intelligence',
    capability: 'CTG Knowledge authenticated source-grounded RAG pilot',
    status: 'PARTIAL',
    publicStatus: 'BETA',
    evidence: [
