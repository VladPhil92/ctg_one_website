...
export const TECHNOLOGY_PROOF: ProofItem[] = [
  ...
  },
  {
    ...
    capability: 'Governed AI runtime, RAG and agent architecture',
    status: 'IN DEVELOPMENT',
    evidence: ['Architecture defined', 'Governance defined', 'Human-in-the-loop requirements', 'No general production runtime claimed'],
    publicPath: '/ai',
  },
  {
    id: 'web3',
...
export const TECHNICAL_CHANGELOG = [
  ...
  { phase: '07', title: 'Public technical proof', detail: 'Introduces public status, Labs framework and technical changelog as verifiable evidence surfaces.' },
] as const;
