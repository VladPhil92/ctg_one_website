export const EXPECTED_DATABASE_MIGRATION = '0105' as const;
export const EXPECTED_DATABASE_MIGRATION_NAME = 'wallet_rls_query_plan_hardening' as const;
export const EXPECTED_DATABASE_MIGRATION_COUNT = 105 as const;
