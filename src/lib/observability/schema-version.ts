export const EXPECTED_DATABASE_MIGRATION = '0114' as const;
export const EXPECTED_DATABASE_MIGRATION_NAME = 'revoke_legacy_financial_rpc_client_execution' as const;
export const EXPECTED_DATABASE_MIGRATION_COUNT = 114 as const;
