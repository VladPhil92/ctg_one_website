export const EXPECTED_DATABASE_MIGRATION = '0120' as const;
export const EXPECTED_DATABASE_MIGRATION_NAME = 'jp_education_service_role_boundary_reconciliation' as const;
export const EXPECTED_DATABASE_MIGRATION_COUNT = 120 as const;
