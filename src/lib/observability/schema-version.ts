export const EXPECTED_DATABASE_MIGRATION = '0094' as const;
export const EXPECTED_DATABASE_MIGRATION_NAME = 'jp_event_registrations' as const;
export const EXPECTED_DATABASE_MIGRATION_COUNT = 94 as const;
