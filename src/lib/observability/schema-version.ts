export const EXPECTED_DATABASE_MIGRATION = '0125' as const;
export const EXPECTED_DATABASE_MIGRATION_NAME = 'runtime_schema_requirement_probe' as const;
export const EXPECTED_DATABASE_MIGRATION_COUNT = 125 as const;
