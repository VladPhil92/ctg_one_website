export const EXPECTED_DATABASE_MIGRATION = '0095' as const;
export const EXPECTED_DATABASE_MIGRATION_NAME = 'jp_education_commerce' as const;
export const EXPECTED_DATABASE_MIGRATION_COUNT = 95 as const;
