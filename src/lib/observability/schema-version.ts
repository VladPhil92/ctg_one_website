export const EXPECTED_DATABASE_MIGRATION = '0096' as const;
export const EXPECTED_DATABASE_MIGRATION_NAME = 'jp_education_checkout_hardening' as const;
export const EXPECTED_DATABASE_MIGRATION_COUNT = 96 as const;
