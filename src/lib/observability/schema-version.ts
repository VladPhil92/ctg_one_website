export const EXPECTED_DATABASE_MIGRATION = '0110' as const;
export const EXPECTED_DATABASE_MIGRATION_NAME = 'service_federation_rate_limits' as const;
export const EXPECTED_DATABASE_MIGRATION_COUNT = 110 as const;
