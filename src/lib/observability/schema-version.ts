export const EXPECTED_DATABASE_MIGRATION = '0102' as const;
export const EXPECTED_DATABASE_MIGRATION_NAME = 'vertice_federation_authorization_codes' as const;
export const EXPECTED_DATABASE_MIGRATION_COUNT = 102 as const;
export const EXPECTED_DATABASE_MIGRATION = '0101' as const;
export const EXPECTED_DATABASE_MIGRATION_NAME = 'expand_acquisition_service_portfolio_craft_beer' as const;
export const EXPECTED_DATABASE_MIGRATION_COUNT = 101 as const;
