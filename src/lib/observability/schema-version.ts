export const EXPECTED_DATABASE_MIGRATION = '0126' as const;
export const EXPECTED_DATABASE_MIGRATION_NAME = 'ecosystem_federation_layer' as const;
export const EXPECTED_DATABASE_MIGRATION_COUNT = 126 as const;
