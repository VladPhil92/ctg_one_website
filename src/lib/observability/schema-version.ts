export const EXPECTED_DATABASE_MIGRATION = '0117' as const;
export const EXPECTED_DATABASE_MIGRATION_NAME = 'jp_education_academic_operations' as const;
export const EXPECTED_DATABASE_MIGRATION_COUNT = 117 as const;
