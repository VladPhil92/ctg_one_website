...
export const PISAO_CANONICAL_ORIGIN = 'https://pisaogastrobar.com';
export const PISAO_FEDERATION_PROVIDER = 'pisao' as const;
export const PISAO_AUTHORIZATION_CODE_TTL_MS = 60_000;
...
export function federationSecretState(request: Request): 'unconfigured' | 'authorized' | 'unauthorized' {
  const expected = process.env.PISAO_FEDERATION_SECRET?.trim() ?? '';
