...
export default function ReferenceDashboard() {
  ...
  const derivedActivities = useMemo<DashboardActivity[]>(() => {
    const items: DashboardActivity[] = transactions.map((tx) => ({
      id: tx.id,
            ...
            <div className="ctgPrimaryColumn">
              ...
              <section className="ctgLowerGrid">
                ...
                <Link href="/products" className="ctgImpactCard">
                  ...
                  <Image className="ctgImpactLogo" src="/images/logo/ctg-one-coin-icon.png" alt="" width={205} height={205} aria-hidden="true" />
                </Link>
              </section>
            </div>
