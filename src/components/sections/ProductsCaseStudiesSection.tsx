...
export const ProductsCaseStudiesSection: React.FC = () => {
  ...
  const capabilities: Capability[] = es
    ? [
        ...
        { icon: FileText, title: 'Ledger transaccional', description: 'Registro de movimientos y eventos económicos del bounded context.', status: 'LIVE' },
    ...
    : [
        ...
        { icon: FileText, title: 'Transactional ledger', description: 'Record of movements and economic events inside the bounded context.', status: 'LIVE' },
