        ...
        <div className="max-w-2xl mx-auto">
          <FadeInSection>
            <div className="text-center mb-16 md:mb-20">
              <Badge variant="accent" className="mb-8">{CONTACT.badge}</Badge>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-outfit font-semibold mb-5 tracking-tight">
                {CONTACT.title}{' '}<span className="text-accent">{CONTACT.titleHighlight}</span>
              </h2>
              <p className="text-sm md:text-base text-text-muted leading-relaxed max-w-md mx-auto px-4">{CONTACT.description}</p>
            </div>
          </FadeInSection>
          ...
          <FadeInSection delay={0.2}>
            <div className="text-center mb-12 md:mb-16">
              <h3 className="text-sm md:text-base font-outfit font-medium text-white mb-3">Ready to Transform Your Business?</h3>
              <p className="text-[13px] md:text-sm text-text-muted mb-8 px-4">Let&apos;s discuss how CTG One can help you achieve your goals.</p>
              <Button href={`mailto:${CONTACT.email}`} variant="primary" size="md">Send Message</Button>
            </div>
          </FadeInSection>
