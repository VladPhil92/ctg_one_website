...
const ITEMS = [
  { href: '/about', badge: ABOUT.badge, title: `${ABOUT.title} ${ABOUT.titleHighlight}`, description: ABOUT.description, icon: <Eye size={20} strokeWidth={1.5} /> },
  { href: '/services', badge: SERVICES.badge, title: `${SERVICES.title} ${SERVICES.titleHighlight}`, description: SERVICES.description, icon: <Cpu size={20} strokeWidth={1.5} /> },
  { href: '/ecosystem', badge: ECOSYSTEM.badge, title: `${ECOSYSTEM.title} ${ECOSYSTEM.titleHighlight}`, description: ECOSYSTEM.description, icon: <Network size={20} strokeWidth={1.5} /> },
  { href: '/rewards', badge: REWARDS.badge, title: `${REWARDS.title} ${REWARDS.titleHighlight}`, description: REWARDS.description, icon: <Award size={20} strokeWidth={1.5} /> },
  { href: '/token', badge: TOKEN.badge, title: `${TOKEN.title} ${TOKEN.titleHighlight}`, description: TOKEN.description, icon: <Wallet size={20} strokeWidth={1.5} /> },
  { href: '/contact', badge: CONTACT.badge, title: `${CONTACT.title} ${CONTACT.titleHighlight}`, description: CONTACT.description, icon: <Mail size={20} strokeWidth={1.5} /> },
];
