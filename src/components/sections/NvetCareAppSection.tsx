...
export const NvetCareAppSection: React.FC = () => {
  ...
  const copy = es ? {
    ...
    statusBadge: 'Estado del producto', statusTitle: 'Estado del producto', statusText: 'Estamos construyendo Nvet Care con cariño, un paso a la vez. No prometemos nada que no puedas ver funcionando de verdad, así que siempre sabrás exactamente en qué va el proyecto.',
    evidenceTitle: 'Cero promesas vacías', evidenceText: 'No vas a encontrar aquí funciones de adorno ni fechas inventadas. Lo que ves en esta página es justo lo que estamos construyendo, y se actualiza en el momento en que algo esté realmente listo — no antes.',
    audienceBadge: '01 · Para quién es', audienceTitle: 'Pensado para quienes cuidan y para quienes curan.', audienceText: 'Ya seas quien busca cuidado para su mascota o el veterinario que lo brinda a domicilio, Nvet Care está pensado para hacerte la vida más fácil.',
    ...
    vetTitle: 'Veterinarios verificados', vetItems: ['Verifica tu identidad y credenciales', 'Define tu disponibilidad y zona de cobertura', 'Atiende visitas a domicilio', 'Recibe tu pago de forma segura, sin sorpresas'],
    stepsBadge: '02 · Cómo funcionará', stepsTitle: 'Pide ayuda para tu mascota en simples pasos.', stepsText: 'Así imaginamos la experiencia completa. La iremos activando por partes, y te avisaremos en cada paso.',
    steps: [
    ...
    capsBadge: '03 · En qué vamos', capsTitle: 'Te contamos exactamente en qué va cada parte.', capsText: 'Nada de humo: son los mismos estados que mostramos en todo el ecosistema CTG One, para que siempre sepas qué es real.',
    capsLink: 'Ver todo el progreso del ecosistema',
    trustBadge: '04 · Cómo cuidamos tu confianza', trustTitle: 'Tu tranquilidad, no negociable.', trustText: 'Estos son los compromisos que guían cada decisión que tomamos, incluso antes de que la app esté lista.',
    trustItems: [
      ...
      { icon: Eye, title: 'Tus datos, siempre protegidos', text: 'Acceso a información sensible limitado por identidad y propósito.' },
    ],
    faqBadge: 'Preguntas frecuentes', faqTitle: 'Lo que la gente suele preguntar.',
    faqs: [
      { q: '¿Cuándo estará disponible?', a: 'Aún no hay fecha pública de lanzamiento. Puedes seguir el avance real en nuestra página de novedades.' },
    ...
    galleryTitle: 'Así imaginamos cada pantalla.',
    galleryText: 'Bocetos del diseño que estamos construyendo — no capturas de una app que ya puedas descargar.',
    ...
    followProgress: 'Follow our progress', followProgressHref: '/changelog',
    statusBadge: 'Product status', statusTitle: 'Product status', statusText: 'We’re building Nvet Care with care, one step at a time. We won’t promise anything you can’t actually see working — so you’ll always know exactly where the project stands.',
    evidenceTitle: 'Zero empty promises', evidenceText: 'You won’t find decorative features or made-up dates here. What you see on this page is exactly what we’re building, and it updates the moment something is truly ready — not before.',
    audienceBadge: '01 · Who it is for', audienceTitle: 'Built for the people who care, and the vets who heal.', audienceText: 'Whether you’re looking for care for your pet or you’re the veterinarian delivering it at home, Nvet Care is designed to make your life easier.',
    ...
    vetTitle: 'Verified veterinarians', vetItems: ['Verify your identity and credentials', 'Set your availability and coverage area', 'Deliver home visits', 'Get paid securely, no surprises'],
    stepsBadge: '02 · How it will work', stepsTitle: 'Get help for your pet in a few simple steps.', stepsText: 'This is how we picture the full experience. We’ll turn it on piece by piece, and let you know every step of the way.',
    steps: [
    ...
    capsBadge: '03 · Where things stand', capsTitle: 'We’ll tell you exactly where every piece stands.', capsText: 'No smoke and mirrors: these are the same statuses shown across the whole CTG One ecosystem, so you always know what’s real.',
    capsLink: 'See the ecosystem’s full progress',
    trustBadge: '04 · How we protect your trust', trustTitle: 'Your peace of mind, non-negotiable.', trustText: 'These are the commitments guiding every decision we make, even before the app is ready.',
    trustItems: [
      ...
      { icon: Eye, title: 'Your data, always protected', text: 'Access to sensitive information limited by identity and purpose.' },
    ],
    faqBadge: 'Frequently asked questions', faqTitle: 'What people usually ask.',
    faqs: [
      { q: 'When will it be available?', a: 'There is no public launch date yet. You can follow real progress on our updates page.' },
    ...
    galleryTitle: 'Here’s how we picture every screen.',
    galleryText: 'Sketches of the design we’re building — not screenshots of an app you can download yet.',
